...
{"ERR_PGMODELER_ARQNAOGRAVADO", QObject::tr("Unable to write the model in the file %1! Make sure the directory exists, or if the user has access permissions on it!")},
