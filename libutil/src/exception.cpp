...
{"ERR_CUSTOM", " "},
{"ERR_INSUF_MEMORY", QT_TR_NOOP("Insufficient memory space to allocate the object!")},
...
{"ERR_ASG_INV_TYPE_OBJECT", QT_TR_NOOP("Assigning object of an invalid type!")},
...
{"ERR_REF_PARAM_INV_INDEX", QT_TR_NOOP("Reference to a parameter which index is out of the parameter list capacity!")},
...
{"ERR_REF_ARG_INV_INDEX", QT_TR_NOOP("Reference to an argument which index is out of argument list capacity!")},
{"ERR_INS_DUPLIC_COLUMN", QT_TR_NOOP("Insertion of a column which name is already registered to another column of the object!")},
{"ERR_ASG_EMPTY_NAME_OBJECT", QT_TR_NOOP("Assignment of empty name to an object!")},
{"ERR_ASG_INV_NAME_OBJECT", QT_TR_NOOP("Assignment of invalid name to an object!")},
...
{"ERR_REF_ROLE_INV_INDEX", QT_TR_NOOP("Reference to a paper which index is out of paper list capacity!")},
{"ERR_INS_EMPTY_RULE_COMMAND", QT_TR_NOOP("Insertion of empty command to the rule!")},
{"ERR_REF_RULE_CMD_INV_INDEX", QT_TR_NOOP("Reference to a command which index is out of the command list capacity!")},
...
{"ERR_ASG_ESQVALORMININV", QT_TR_NOOP("Assignment of a minimum value to the sequence which is greater than the maximum value!")},
{"ERR_ASG_ESQVALORINIINV", QT_TR_NOOP("Assignment of a start value to the sequence which is extrapolating the range defined by minimum and maximum values​​!")},
{"ERR_ASG_ESQINCNULO", QT_TR_NOOP("Assignment of a null increment value to the sequence!")},
{"ERR_ASG_ESQCACHENULO", QT_TR_NOOP("Assignment of null cache value to the sequence!")},
{"ERR_ASG_ESQDIFTAB", QT_TR_NOOP("Assignment of owner table which is not in the same schema as the sequence '%1'!")},
{"ERR_ASG_DONODIFTAB", QT_TR_NOOP("Assignment of owner table which does not belong to the same owner of the sequence '%1'!")},
{"ERR_ASG_COLPOSINDEF", QT_TR_NOOP("Assignment of a nonexistent owner column to the sequence '%1'!")},
{"ERR_ASG_COLPOSNAORELAC", QT_TR_NOOP("Assignment of an owner column to the sequence '%1' that is not related to any table!")},
{"ERR_REF_ROTIDXINV", QT_TR_NOOP("Reference to a label which index is out of labels list capacity!")},
...
{"ERR_REF_ATTRIB_INV_INDEX", QT_TR_NOOP("Reference to an attribute which index is out of the attributes list capacity!")},
{"ERR_REF_ENUM_INV_INDEX", QT_TR_NOOP("Reference to an enumeration which index is out of the enumerations list capacity!")},
...
{"ERR_ASG_INV_ID_USER", QT_TR_NOOP("Assignment of invalid id to the user!")},
...
{"ERR_REF_ELEM_INV_INDEX", QT_TR_NOOP("Reference to an element which index is out of element list capacity!")},
{"ERR_REF_OBJ_INV_INDEX", QT_TR_NOOP("Reference to an object which index is out of object list capacity!")},
