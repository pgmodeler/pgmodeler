...
* [New] Added the ability to toggle magnifier tool in main window.
* [New] Added a text search widget in diff code preview on ModelDatabaseDiffForm.
* [New] Added unary operators for enum operations: |= , &= , ^=
* [New] Added a new implemantation of CSV file loading based on RFC4180. Now the classes CsvParse and CsvDocument are the responsible for parsing CSV files.
* [Change] Disabled unneeded conditional code in MainWindow.
* [Change] Adjusted the font weight in tool bar actions.
* [Change] Minor text adjustment in DonateWidget.
* [Change] Minor adjustement in UI stylesheets.
* [Change] Refactored TemplateType and all its derived classes in order to avoid the error "explicit specialization of 'type_names'" when building with clang.
...
* [Change] Adjusted the behavior of magnifier action in MainWindow.
* [Change] Minor adjustment in MainWindow::setBottomFloatingWidgetPos in order to take into account the main menu bar height when visible.
...
* [Change] Adjusted the icon of the current input model/db in partial diff tab in ModelDatabaseDiffForm.
* [Change] Adjusting the context object in thread signal/slot connections in ModelExportForm.
* [Change] Adjusted plugins and arrage object actions in main menu.
* [Change] Adjusted the captured variables in lambda slots avoiding default capturing [&].
* [Change] Added a context object parameter in connect() which receive lambda slots.
* [Change] Refactored MainWindow signal/slot connections to new syntax.
* [Change] Refactored ModelWidget signal/slot connections to new syntax.
* [Change] Refactored ModelDatabaseDiffForm signal/slot connections to new syntax.
* [Change] Refactored ModelExportForm signal/slot connections to new syntax.
* [Change] Refactored ModelObjectsWidget signal/slot connections to new syntax.
* [Change] Refactored ModelValidationWidget signal/slot connections to new syntax.
* [Change] Refactored SQLExecutionWidget signal/slot connections to new syntax.
* [Change] Refactored TableDataWidget signal/slot connections to new syntax.
* [Change] Refactored SourceCodeWidget signal/slot connections to new syntax.
* [Change] Refactored UpdateNotifierWidget signal/slot connections to new syntax.
* [Change] Refactored OperationListWidget signal/slot connections to new syntax.
* [Change] Refactored ObjectsTableWidget signal/slot connections to new syntax.
* [Change] Refactored ObjectsFilterWidget signal/slot connections to new syntax.
* [Change] Refactored ObjectSelectorWidget signal/slot connections to new syntax.
* [Change] Refactored ObjectRenameWidget signal/slot connections to new syntax.
* [Change] Refactored ObjectFinderWidget signal/slot connections to new syntax.
* [Change] Refactored ObjectDepsRefsWidget signal/slot connections to new syntax.
* [Change] Refactored NumberedTextEditor signal/slot connections to new syntax.
* [Change] Refactored NewObjectOverlayWidget signal/slot connections to new syntax.
* [Change] Refactored ModelOverviewWidget signal/slot connections to new syntax.
* [Change] Refactored ModelNavigationWidget signal/slot connections to new syntax.
* [Change] Refactored LineNumbersWidget signal/slot connections to new syntax.
* [Change] Refactored LayersWidget signal/slot connections to new syntax.
* [Change] Refactored LayersConfigWidget signal/slot connections to new syntax.
* [Change] Refactored FindReplaceWidget signal/slot connections to new syntax.
* [Change] Refactored FileSelectorWidget signal/slot connections to new syntax.
* [Change] Refactored CustomSQLWidget signal/slot connections to new syntax.
* [Change] Refactored CsvLoadWidget signal/slot connections to new syntax.
* [Change] Refactored ColorPickerWidget signal/slot connections to new syntax.
* [Change] Refactored CodeCompletionWidget signal/slot connections to new syntax.
* [Change] Refactored ChangelogWidget signal/slot connections to new syntax.
* [Change] Refactored SQLToolWidget signal/slot connections to new syntax.
* [Change] Disabled custom font size for hint boxes in BaseObjectWidget, ModelDatabaseDiffForm, ModelFixForm, ModelWidget.
* [Change] Refactored SwapObjectsIdsWidget signal/slot connections to new syntax.
* [Change] Refactored ModelValidationHelper signal/slot connections to new syntax.
* [Change] Refactored ModelRestorationForm signal/slot connections to new syntax.
* [Change] Refactored ModelFixForm signal/slot connections to new syntax.
* [Change] Refactored ModelExportHelper signal/slot connections to new syntax.
* [Change] Refactored MetadataHandlingForm signal/slot connections to new syntax.
* [Change] Refactored DataManipulationForm signal/slot connections to new syntax.
* [Change] Refactored DatabaseImportForm signal/slot connections to new syntax.
* [Change] Refactored DatabaseExplorerWidget signal/slot connections to new syntax.
* [Change] Refactored BugReportForm signal/slot connections to new syntax.
* [Change] Refactored SnippetsConfigWidget signal/slot connections to new syntax.
* [Change] Refactored RelationshipConfigWidget signal/slot connections to new syntax.
* [Change] Refactored BaseForm::setMainWidget to use the new signal/slot connections to syntax
* [Change] Refactored PluginsConfigWidget signal/slot connections to new syntax.
* [Change] Refactored GeneralConfigWidget signal/slot connections to new syntax.
* [Change] Refactored ConnectionConfigWidget signal/slot connections to new syntax.
* [Change] Refactored Messagebox signal/slot connections to new syntax.
* [Change] Refactored ViewWidget signal/slot connections to new syntax.
* [Change] Refactored TypeWidget signal/slot connections to new syntax.
* [Change] Refactored TriggerWidget signal/slot connections to new syntax.
* [Change] Refactored TextboxWidget signal/slot connections to new syntax.
* [Change] Refactored TableWidget signal/slot connections to new syntax.
* [Change] Refactored SequenceWidget signal/slot connections to new syntax.
* [Change] Refactored RuleWidget signal/slot connections to new syntax.
* [Change] Refactored RoleWidget signal/slot connections to new syntax.
* [Change] Refactored RelationshipWidget signal/slot connections to new syntax.
* [Change] Refactored ReferenceWidget signal/slot connections to new syntax.
* [Change] Refactored ProcedureWidget signal/slot connections to new syntax.
* [Change] Refactored PolicyWidget signal/slot connections to new syntax.
* [Change] Refactored PgSqlTypeWidget signal/slot connections to new syntax.
* [Change] Refactored PermissionWidget signal/slot connections to new syntax.
* [Change] Refactored ParameterWidget signal/slot connections to new syntax.
* [Change] Refactored OperatorClassWidget signal/slot connections to new syntax.
...
* [Change] Refactored IndexWidget signal/slot connections to new syntax.
* [Change] Refactored GenericSqlWidget signal/slot connections to new syntax.
* [Change] Refactored FunctionWidget signal/slot connections to new syntax.
* [Change] Refactored EventTriggerWidget signal/slot connections to new syntax.
* [Change] Refactored ElementWidget signal/slot connections to new syntax.
* [Change] Refactored ElementsTableWidget signal/slot connections to new syntax.
* [Change] Refactored DomainWidget signal/slot connections to new syntax.
* [Change] Refactored ConstraintWidget signal/slot connections to new syntax.
* [Change] Refactored ColumnWidget signal/slot connections to new syntax.
* [Change] Refactored ColumnPickerWidget signal/slot connections to new syntax.
* [Change] Refactored CollationWidget signal/slot connections to new syntax.
* [Change] Refactored BaseObjectWidget signal/slot connections to new syntax.
* [Change] Refactored BaseFunctionWidget signal/slot connections to new syntax.
* [Change] Refactored AggregateWidget signal/slot connections to new syntax.
* [Change] Refactored BaseForm signal/slot connections to new syntax.
* [Change] Refactored SchemaView signal/slot connections to new syntax.
* [Change] Refactored TableView signal/slot connections to new syntax.
* [Change] Refactored TextboxView signal/slot connections to new syntax.
* [Change] Refactored RelationshipView signal/slot connections to new syntax.
* [Change] Refactored ObjectsScene signal/slot connections to new syntax.
* [Change] Refactored GraphicalView signal/slot connections to new syntax.
* [Change] Refactored BaseObjectView signal/slot connections to new syntax.
* [Change] Refactored SourceEditorWidget signal/slot connections to new syntax.
* [Change] Refactored SchemaEditorForm signal/slot connections to new syntax.
* [Change] Refactored PgModelerCliApp signal/slot connections to new syntax.
* [Change] Refactored CrashHandlerForm signal/slot connections to new syntax.
...
* [Change] Removed unused consts in SourceCodeWidget.
* [Change] Moved config widget ids consts in ConfigurationForm to ConfigurationForm::ConfWidgetsId.
* [Change] Moved main window view ids to MainWindow::MWViewsId.
* [Change] Moved table buttons and item color consts in ObjectsTableWidget to ObjectsTableWidget::ButtonConf and ObjectsTableWidget::TableItemColor.
* [Change] Moved index attributes (buffering, concurrent, unique) consts to Index::IndexAttribs.
* [Change] Moved relationship break mode ids in ModelWidget to ModelWidget::RelBreakMode.
* [Change] Moved validation info type consts in ValidationInfo to ValidationInfo::ValType.
* [Change] Moved diff type consts in ObjectsDiffInfo to ObjectsDiffInfo::DiffType.
* [Change] Moved diff options consts in ModelsDiffHelper to ModelsDiffHelper::DiffOptions.
* [Change] Moved thread ids consts in ModelDatabaseDiffForm to ModelDatabaseDiffForm::ThreadId.
* [Change] Moved row operation ids consts in DataManipulationForm to DataManipulationForm::OperationId.
* [Change] Moved object attibute ids in DatabaseImportForm to DatabaseImportForm::ObjectAttrId
* [Change] Moved icon types and buttons ids constants in Messagebox to, respectively, Messagebox::IconType and Messagebox::ButtonsId.
...
* [Change] Minor improvement in DatabaseImportHelper::getObjectName to cache names and signatures to avoid repeatedly configure names on each call.
* [Change] Moved the type function ids consts in Type  to Type::FunctionId.
* [Change] Moved the type config constants in Type to Type::TypeConfig.
* [Change] Moved font factor consts in namespace GuiUtils to GuiUtilsNs::FontFactorId.
* [Change] Moved transition table ids in Trigger to Trigger::TransitionTableId.
* [Change] Moved transfom funcs constants in Transform to Transform::FunctionId.
...
* [Change] Moved the Tag::ColorId to the global scope in basegraphicobject.h since the enum usage is not exclusive for tags.
...
* [Change] Moved name pattern consts in Relationship to Relationship::PatternId.
...
* [Change] Minor change in databaseimportform.ui, moved the tool buttons that controls items selection/collapsing to the top of the section.
...
* [Change] Move cast type consts to enum Cast::CastType.
...
* [Change] Moved the constexpr attributes that references toggler buttons to enum AttributesTogglerItem::TogglerButton.
* [Change] Reunited all row editing actions in DataManipulationForm in a single menu under "Edit" action.
* [Change] In SQLToolWidget when requesting the source code display of an object in the objects' tree, the source code pane will be poped up if not being shown.
...
* [Change] Minor adjustment in CsvParser to raise exception on malformed document due to missing close text delimiter.
...
* [Fix] Additional fix for false-positive diffs when functions were using array of user-defined types.
* [Fix] Fixed a crash happening in the moment a renamed object got its source reloaded in DatabaseExplorerWidget.
* [Fix] Fixed a bug in CopyOptions that was not initializing attributes in default constructor.
...
* [Fix] Fixed UpdateNotifierWidget style for dark theme.
* [Fix] Fixed a bug in Catalog::getCatalogQuery that was not placing the custom filter in the right place in the query.
* [Fix] Fixed a bug that was reseting the fade out state of objects.
* [Fix] Fixed a bug in database import that was failing to import operators in certain cases.
* [Fix] Fixed a bug when importing functions which contain parameters composed by arrays of user-defined types.
