...
TableWidget::TableWidget(QWidget *parent, ObjectType tab_type): BaseObjectWidget(parent, tab_type)
{
	...
	connect(objects_tab_map[ObjectType::Column], &ObjectsTableWidget::s_cellClicked, this, [&](int row, int col){
	...
	connect(partitioning_type_cmb, &QComboBox::currentTextChanged, this, [&](){
