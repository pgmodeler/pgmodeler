...
TEMPDIR="/tmp"
QMAKE_ARGS="QMAKE_ARGS PREFIX=$PREFIX BINDIR=$BINDIR \
            PRIVATEBINDIR=$PRIVATEBINDIR PRIVATELIBDIR=$PRIVATELIBDIR \
            LANGDIR=$LANGDIR SAMPLESDIR=$SAMPLESDIR SCHEMASDIR=$SCHEMASDIR \
            TEMPDIR=$TEMPDIR"
