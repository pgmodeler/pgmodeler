...
class BaseRelationship: public BaseGraphicObject  {
	...
	public:
		...
		RELATIONSHIP_PART=15,//! \brief Partitioning relationship
		RELATIONSHIP_FK=16; //! \brief Relationship generated by creating a foreign key manually on a table
		...
		static constexpr unsigned SRC_TABLE=0,
		DST_TABLE=1;
