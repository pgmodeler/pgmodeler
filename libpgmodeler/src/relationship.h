...
class Relationship: public BaseRelationship {
	private:
		...
		/*! \brief Indicates that the column suffixes must be created automaticaly based
		...
		/*! \brief Stores the suffixes generated for the columns created by the relationship.
		...
		//! \brief Tables suffixes used to create unique names for the created columns
	...
	public:
		...
		//! \brief Defines the automatic suffix generation for column names
		void setAutomaticSuffix(bool value);

		//! \brief Returns the current state for automatic column name suffix generation
		...
		//! \brief Defines the suffix for the specified table id
		void setTableSuffix(unsigned table_id, const QString &suffix);

		//! \brief Returns the suffix for the specified table id
