...
class Column: public TableObject{
	...
	public:
		...
		bool isIdSeqCycle(void);
		QString getIdSeqMaxValue(void);
		QString getIdSeqMinValue(void);
		QString getIdSeqIncrement(void);
		QString getIdSeqStart(void);
		QString getIdSeqCache(void);
