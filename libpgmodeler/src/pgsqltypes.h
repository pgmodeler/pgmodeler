...
class BaseType{
	private:
		static const unsigned types_count=202;
...
class SpatialType: public BaseType{
	private:
		unsigned variation;
		static const unsigned offset=195;
...
class PgSQLType: public BaseType{
	private:
		...
		static const unsigned types_count=76;

		//! \brief Offset for oid types
		static const unsigned oid_start=80;
		static const unsigned oid_end=91;

		//! \brief Offset for pseudo types
		static const unsigned pseudo_start=92;
		static const unsigned pseudo_end=103;
...
class LanguageType: public BaseType{
	private:
		static const unsigned offset=122;
...
class MatchType: public BaseType{
	private:
		static const unsigned offset=173;
		static const unsigned types_count=3;
...
class DeferralType: public BaseType{
	private:
		static const unsigned offset=176;
		static const unsigned types_count=2;
...
class CategoryType: public BaseType{
	private:
		static const unsigned offset=178;
...
class FiringType: public BaseType{
	private:
		static const unsigned offset=192;
		static const unsigned types_count=3;
