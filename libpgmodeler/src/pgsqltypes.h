...
class BaseType{
	private:
		static const unsigned types_count=200;
...
class SpatialType: public BaseType{
	private:
		unsigned variation;
		static const unsigned offset=193;
...
class PgSQLType: public BaseType{
	private:
		...
		static const unsigned types_count=74;

		//! \brief Offset for oid types
		static const unsigned oid_start=78;
		static const unsigned oid_end=89;

		//! \brief Offset for pseudo types
		static const unsigned pseudo_start=90;
		static const unsigned pseudo_end=101;
...
class SecurityType: public BaseType{
	private:
		static const unsigned offset=118;
		static const unsigned types_count=2;
...
class EncodingType: public BaseType{
	private:
		static const unsigned offset=126;
...
class MatchType: public BaseType{
	private:
		static const unsigned offset=171;
		static const unsigned types_count=3;
...
class FiringType: public BaseType{
	private:
		static const unsigned offset=190;
		static const unsigned types_count=3;
