...
#ifndef QTEXTSTREAM_COMPAT_H
#define QTEXTSTREAM_COMPAT_H

#include <QTextStream>

namespace QtCompat {
	/*! \brief This is acts like the QTextStream::endl() in Qt versions prior to 5.15.
	 * When using Qt 5.15, this method acts like Qt::endl(). */
