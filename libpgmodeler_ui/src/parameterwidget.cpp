...
ParameterWidget::ParameterWidget(QWidget *parent): BaseObjectWidget(parent, ObjectType::ObjParameter)
{
	try
	{
		...
		configureFormLayout(parameter_grid, ObjectType::ObjParameter);
