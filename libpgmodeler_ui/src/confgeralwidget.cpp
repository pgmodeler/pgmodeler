...
void ConfGeralWidget::aplicarConfiguracao(void)
{
 ...
 ObjectsScene::definirConfiguracaoPagina(static_cast<QPrinter::PaperSize>(papel_cmb->itemData(papel_cmb->currentIndex()).toInt()),
 ...
 ObjectsScene::definirGrade(tam_grade_spb->value());
