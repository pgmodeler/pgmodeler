...
class SyntaxHighlighter: public QSyntaxHighlighter {
 private:
  ...
  /** @details Classe auxiliar do destacador que indica em qual bloco e
     coluna se inicia e termina um determinado grupo de destaque multi linha */
  class MultiLineInfo: public QTextBlockUserData {
   public:
    int start_col, /// @details Coluna onde se inicia a info multilinha
        start_block, /// @details Bloco (linha) onde se inicia a info multilinha
