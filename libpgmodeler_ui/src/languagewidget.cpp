...
LanguageWidget::LanguageWidget(QWidget *parent): BaseObjectWidget(parent, ObjectType::ObjLanguage)
{
	try
	{
		...
		func_handler_sel=new ObjectSelectorWidget(ObjectType::ObjFunction, true, this);
		func_validator_sel=new ObjectSelectorWidget(ObjectType::ObjFunction, true, this);
		func_inline_sel=new ObjectSelectorWidget(ObjectType::ObjFunction, true, this);
		...
		configureFormLayout(language_grid, ObjectType::ObjLanguage);
